              ...
              Container(
                ...
                child: Padding(
                    ...
                    child: ListView.builder(
                        itemCount: islamicCenterController.islamicCenterModel.countries![countryIndex].centers!.length,
                        itemBuilder:(context,index) =>
                            CustomListTile(
                              index: index,
                              title: islamicCenterController.islamicCenterModel.countries![countryIndex].centers![index].title!,
                          onTap: (){
                            Get.to(()=> DescriptionScreen(countryIndex: countryIndex,centerIndex: index,));
                          },
                        )
