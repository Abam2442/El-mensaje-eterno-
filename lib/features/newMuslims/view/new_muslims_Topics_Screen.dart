...
class NewMuslimsTopicsScreen extends StatelessWidget {
  NewMuslimsTopicsScreen({super.key, required this.CategoryIndex, required this.Index, required this.title, });
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
            title ),
        actions: [
          CopyButton(text: newMuslimsController.categorySpModel[CategoryIndex].value![Index].value ?? '')
        ],
      ),
      body:
