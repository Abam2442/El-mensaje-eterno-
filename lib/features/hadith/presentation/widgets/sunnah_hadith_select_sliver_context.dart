...
class SunnahBookSelectSliver extends GetView<HadithController> {
    SunnahBookSelectSliver({super.key});
          ...
          if(controller.pageNumber ==0) {
            ...
            controller.bookHadithesNameForList.addAll(
                controller.getbookHadithesName!.getRange(
                    0, controller.getbookHadithesName!.take(20).length));
          }
          return  Column(
              children: [
                Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              NumberPaginator(
                                ...
                                numberPages: controller.getbookHadithesName!.take(20).length <20?1:(controller.getbookHadithesName!.length/20).round(),
                                onPageChange: (int pageNumber) {
                                  controller.pageNumber = pageNumber;
                                    controller.bookHadithesNameForList.clear();
                                  controller.bookHadithesNameForList = <String>[].obs;
                                  if (pageNumber == 0) {
                                    controller.bookHadithesNameForList.addAll(
                                        controller.getbookHadithesName!.getRange(
                                            0, controller.getbookHadithesName!.take(20).length));
                                    ...
                                    controller.bookHadithesNameForList.addAll(
                                        controller.getbookHadithesName!.getRange(
                                          (pageNumber *20),controller.getbookHadithesName!.take(((pageNumber+1) *20) ).length,));
                                  }
                                  controller.update();
                                },
                              ...
                              Obx(()=>controller.bookHadithesNameForList.isEmpty?Container(height: Get.height*0.5,child: Center(child: Text(
                                "neniuj rezultoj",style: TextStyle(color: Colors.black,fontSize: 18),
                              ),),):ListView.builder(itemCount: controller.bookHadithesNameForList.take(20).length,
                                  ...
                                  return PrimaryListTile(
                                    ...
                                    ar: '',
                                    es: controller.bookHadithesNameForList[index],
                                    itemNumber: index + 1,
                                    isSaved: false,
                                  );
                                },))
