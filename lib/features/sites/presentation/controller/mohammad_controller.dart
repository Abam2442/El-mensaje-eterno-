...
class MohammadMessangerControllerImp extends GetxController {
  ...
  Future<void> getArtical() async {
    FixedUseCase mohammadMessangerUseCase = FixedUseCase(Get.find());
    var result = await mohammadMessangerUseCase();
    result.fold(
      (l) async {
