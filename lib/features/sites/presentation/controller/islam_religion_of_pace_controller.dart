...
class IslamReligionOfPaceControllerImp extends GetxController {
  ...
  Future<void> getArtical() async {
    FixedUseCase islamReligionOfPaceUseCase = FixedUseCase(Get.find());
    var result = await islamReligionOfPaceUseCase();
    result.fold(
      (l) async {
