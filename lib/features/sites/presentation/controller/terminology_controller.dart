...
import 'package:hiwayda_oracion_islamica/features/sites/domain/usecase/terminology_usecase.dart';
...
class TerminologyControllerImp extends GetxController {
  ...
  Future<void> getArtical() async {
    TerminologyUsecase terminologyUseCase =
        TerminologyUsecase(categoryRepository: Get.find());
