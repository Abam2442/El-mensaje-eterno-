...
class MessageOfIslamControllerImp extends GetxController {
  ...
  Future<void> getArtical() async {
    FixedUseCase messageOfIslamUseCase = FixedUseCase(Get.find());
    var result = await messageOfIslamUseCase();
    result.fold(
      (l) async {
