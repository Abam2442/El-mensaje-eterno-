...
import '../controller/mohammad_controller.dart';
import '../widget/app_bar_custom.dart';
import '../widget/artical_custom.dart';
import '../widget/inkwell_custom.dart';

class MuhammadMessangerScreen extends StatelessWidget {
  const MuhammadMessangerScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<MohammadMessangerControllerImp>(builder: (controller) {
