...
class NewLifeLessonScreen extends StatelessWidget {
  NewLifeLessonScreen({required this.courseIndex,required this.lessonIndex ,super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('${newLifeController.newLifeModel.courses![courseIndex].lessons![lessonIndex].title}'),
        actions: [
          IconButton(onPressed:() async {
            var data = ClipboardData(text:'${newLifeController.newLifeModel.courses![courseIndex].lessons![lessonIndex].body}');
