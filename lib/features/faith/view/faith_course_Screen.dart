...
class FaithCourseScreen extends StatelessWidget {
  FaithCourseScreen({required this.index, super.key});
              ...
              CustomListTile(
                ...
                onTap: () {
                  Get.to(() => DescriptionScreen(
                        des: '${faithController.faithModel.courses![index].description}',
                      ));
                },
              ),
              SizedBox(
                ...
                child: ListView.builder(
                    itemCount: faithController.faithModel.courses![index].lessons!.length,
                    itemBuilder: (context, i) => CustomListTile(
                          index: i,
                          title: '${faithController.faithModel.courses![index].lessons![i].title}',
                          onTap: () {
                            Get.to(() => FaithLessonScreen(courseIndex: index, lessonIndex: i));
                          },
                        )),
              )
            ],
